...
export const commonCronExpressions = [
  ...
  {
    expression: "0 0 * * *",
    descriptionKey: "commonExpressions.everyDayMidnight",
  },
  {
    expression: "0 0 * * 0",
    descriptionKey: "commonExpressions.everySundayMidnight",
  },
  {
    expression: "0 0 1 * *",
    descriptionKey: "commonExpressions.everyMonthFirst",
  },
  {
    expression: "0 9 * * 1-5",
    descriptionKey: "commonExpressions.everyWeekday9AM",
  },
  { expression: "0 17 * * *", descriptionKey: "commonExpressions.everyDay5PM" },
  {
    expression: "*/15 * * * *",
    descriptionKey: "commonExpressions.every15Minutes",
  },
  {
    expression: "0 12 * * 1",
    descriptionKey: "commonExpressions.everyMondayNoon",
  },
];
