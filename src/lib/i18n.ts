...
const resources = {
  en: {
    translation: {
      ...
      month: 'Month',
      weekday: 'Weekday',
      commonExpressionsTitle: 'Common Expressions',
      ...
      // Common cron expressions descriptions
      commonExpressions: {
        everyMinute: 'Every minute',
        everyHour: 'Every hour',
        everyDayMidnight: 'Every day at midnight',
        everySundayMidnight: 'Every Sunday at midnight',
        everyMonthFirst: 'Every month on the 1st at midnight',
        everyWeekday9AM: 'Every weekday at 9:00 AM',
        everyDay5PM: 'Every day at 5:00 PM',  
  ...
  ja: {
    translation: {
      ...
      month: '月',
      weekday: '曜日',
      commonExpressionsTitle: 'よく使われる式',
      ...
      commonExpressions: {
        ...
        everySundayMidnight: '毎週日曜日午前0時',
        everyMonthFirst: '毎月1日午前0時',
        everyWeekday9AM: '平日午前9時',
        everyDay5PM: '毎日午後5時',
        every15Minutes: '15分毎',
