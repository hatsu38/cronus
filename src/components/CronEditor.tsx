...
export default function CronEditor() {
  ...
  useEffect(() => {
    ...
    if (valid) {
      setDescription(describeCronWithTimezone(cronExpression, t, timezone));
      ...
      <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50 transition-all duration-300 hover:scale-105">
        <div className="bg-white/95 backdrop-blur-md shadow-2xl rounded-2xl border border-white/50 p-3">
          <div className="flex items-center gap-3">
            ...
            >
              <svg
                className="w-6 h-6 text-gray-700 group-hover:text-gray-900 group-hover:scale-110 transition-all"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            >
              <svg
                className="w-6 h-6 text-gray-700 group-hover:text-white group-hover:scale-110 transition-all"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            >
              {copiedUrl ? (
                ...
                <svg
                  className="w-6 h-6 text-gray-700 group-hover:text-blue-600 group-hover:scale-110 transition-all"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
