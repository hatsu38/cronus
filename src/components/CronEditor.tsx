          ...
          <div className="flex items-center justify-center mb-4 gap-3">
            ...
            <div>
              ...
              <div className="mt-3 flex gap-3">
                ...
                <a
                  href={`https://x.com/intent/tweet?text=${encodeURIComponent('CRONUS - Beautiful Cron Expression Editor')}&url=${encodeURIComponent(window.location.href)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-black hover:bg-gray-800 text-white rounded-lg transition-colors duration-200 shadow-lg hover:shadow-xl"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
