...
export default function CronEditor() {
  ...
  // Xでシェアする関数
  const shareOnX = () => {
    const text = `CRONUS - Beautiful Cron Expression Editor\n${cronExpression} (${description})`;
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
        <div className="max-w-7xl mx-auto p-6 space-y-8 pb-24"> {/* pb-24 でボトムバーの分スペース確保 */}
          {/* Header with simplified styling (share buttons removed) */}
      ...
      <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50 transition-all duration-300 hover:scale-105">
        <div className="bg-white/95 backdrop-blur-md shadow-2xl rounded-2xl border border-white/50 p-3">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 px-4 py-2">
              <div className="w-2 h-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full animate-pulse"></div>
              <span className="text-sm font-semibold text-gray-700 whitespace-nowrap">Share CRONUS</span>
            </div>
            ...
            >
              <svg className="w-6 h-6 text-gray-700 group-hover:text-gray-900 group-hover:scale-110 transition-all" fill="currentColor" viewBox="0 0 24 24">
            ...
            <button
              onClick={shareOnX}
              className="p-3 hover:bg-black hover:bg-opacity-10 rounded-xl transition-all duration-200 group"
              title="Share on X"
            >
              <svg className="w-6 h-6 text-gray-700 group-hover:text-white group-hover:scale-110 transition-all" fill="currentColor" viewBox="0 0 24 24">
            ...
            >
              {copiedUrl ? (
                ...
                <svg className="w-6 h-6 text-gray-700 group-hover:text-blue-600 group-hover:scale-110 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
